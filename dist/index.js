...
const consultas = [
    ...
    criarConsulta(2, medico2, paciente2, new Date(), 200),
    criarConsulta(3, medico3, paciente3, new Date(), 500),
    criarConsulta(4, medico2, paciente2, new Date(), 1000),
    criarConsulta(5, medico3, paciente3, new Date(), 110)
];
const consulta1 = criarConsulta(1, medico1, paciente1, new Date(), 350);
const consulta2 = criarConsulta(2, medico2, paciente2, new Date(), 350);
const consultaConfirmada = confirmarConsulta(consulta1);
console.log("=== CONSULTA CONFIRMADA ===");
console.log(exibirConsulta(consultaConfirmada));
const listarConsultas = listarConsultasPorStatus([consulta1], "confirmada");
